...
export default function Contact() {
  return (
    <>
      <div
        className={`${style.bgLight} text-dark bg-light text-center flex-grow-1 pt-5 mt-5 align-self-stretch con`}
      >
        <h2 className=" text-uppercase fw-bold fs-1">
          Contact Section
        </h2>
        <div className="d-flex justify-content-center align-items-center my-3">
          <div className={`me-2 line lineDark`}></div>
          <i className="fa-solid fa-star"></i>
          <div className={`ms-2 line lineDark`}></div>
        </div>
